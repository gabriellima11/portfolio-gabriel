    ...
    return (
        <section id='start' className="w-full">
            <div className="h-screen flex justify-around items-center md:flex-col">
                ...
                <div >
                    <a href="https://github.com/gabriellima11" target='_blank'><img className='md:mx-auto brightness-75 w-3/4 md:w-2/4 bg-gradient-to-tr from-purple-800 via-purple-850 to-purple-900 rounded-full transition-all cursor-pointer hover:scale-110 shadow-lg shadow-black dark:shadow-purple-950' src={FotoPerfil} alt="" /></a>
                </div>
